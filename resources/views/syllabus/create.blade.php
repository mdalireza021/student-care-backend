...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('syllabus.store') }}" method="post" class="" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="question" class="required">Upload File</label>
                ...
                <div class="form-group text-right">
                    <button type="submit" class="btn btn-success btn-sm">Add Syllabus</button>
                </div>
            </form>
        </div>
    </div>
