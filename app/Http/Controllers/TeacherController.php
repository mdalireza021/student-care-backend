...
class TeacherController extends Controller
{
    ...
    {
        $teachers = Teacher::with(['user','attachment','shift','section','school','designation','classes'])->get();
        // dd($teachers->toArray());
    ...
    public function create()
    {
        ...
        $schools = School::all();
        $classes = StudentClass::with(['sections','subjects'])->get();
        $bloodTypes = config('app.blood_types');
        $shifts = Shift::all();
        $designations = Designation::all();

        return view('admin.teacher.create', compact('titles','schools','classes','bloodTypes',
            'genders','shifts','designations'
        ));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $teacher->subjects()->attach($inputs['subject_id']);
    ...
    public function edit(Teacher $teacher)
    {
        ...
        return view('admin.teacher.edit', compact(
            'titles','schools','classes','bloodTypes','genders','shifts','designations',
            'teacher','subjects'
        ));
    }
    ...
    public function update(Request $request, Teacher $teacher)
    {
        ...
        try {
            ...
            $teacher->subjects()->sync($inputs['subject_id']);
